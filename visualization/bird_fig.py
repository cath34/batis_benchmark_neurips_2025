...
test_points2 = pd.read_csv("/Users/cathv/Desktop/PhD/Main Project/Bayesian_SDM_Project/values_per_region/spepig1.csv")
geometry = []
...
for seed in seeds:
    test_points = pd.read_csv(f"/Users/cathv/Desktop/PhD/Main Project/Testing_Env/evaluate_results/results_by_bird/{exp_type}/step_{seed}/spepig1.csv")
...
test_points2 = pd.read_csv("/Users/cathv/Desktop/PhD/Main Project/Bayesian_SDM_Project/values_per_region/graher1.csv")
geometry = []
for i in range(len(test_points2)):
    row = test_points2.iloc[i]
    geometry.append(Point(row['lon'], row['lat']))
...
dataset = []
for seed in seeds:
    test_points = pd.read_csv(f"/Users/cathv/Desktop/PhD/Main Project/Testing_Env/evaluate_results/results_by_bird/{exp_type}/step_{seed}/graher1.csv")
...
test_points2 = pd.read_csv("/Users/cathv/Desktop/PhD/Main Project/Bayesian_SDM_Project/values_per_region/bagwea1.csv")
geometry = []
for i in range(len(test_points2)):
    row = test_points2.iloc[i]
    geometry.append(Point(row['lon'], row['lat']))
...
dataset = []
for seed in seeds:
    test_points = pd.read_csv(f"/Users/cathv/Desktop/PhD/Main Project/Testing_Env/evaluate_results/results_by_bird/{exp_type}/step_{seed}/bagwea1.csv")
